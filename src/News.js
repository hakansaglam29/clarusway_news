                        ...
                        b.map(ahmet => {
                            return (
                                <View> 
                                    ...
                                    />
                                    <Text style={{width: '97.5%',position:'absolute', bottom:5,
                                        backgroundColor:'rgba(128,128,128,0.5)',padding:10,textAlign:'left',alignSelf:'center', 
                                        color:'white', fontWeight:'bold', fontSize:19, borderRadius:10}}
                                    >{ahmet.text}</Text>
                                </View>
                            )
                        })
